package com.smbsoft.uniconnect.config;
...
@Configuration
@EnableMongoRepositories("com.smbsoft.uniconnect.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.smbsoft.uniconnect.config.dbmigrations");
