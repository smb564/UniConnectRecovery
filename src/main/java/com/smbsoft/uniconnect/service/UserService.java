...
import com.smbsoft.uniconnect.config.Constants;
...
import com.smbsoft.uniconnect.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUser(String login, String password, String firstName, String lastName, String email,
        String imageUrl, String langKey, String authorityRole) {

        User newUser = new User();
        Authority authority = authorityRepository.findOne(authorityRole);
    ...
    public UserNotification addNotification(UserNotification userNotification, String login) {
        ...
        Optional<List<UserNotification>> notificationsOptional = Optional.ofNullable(user.get().getNotifications());

        if (!notificationsOptional.isPresent())
            user.get().setNotifications(new ArrayList<>());

        user.get().getNotifications().add(userNotification);
